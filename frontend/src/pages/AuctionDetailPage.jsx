...
import ConditionBadge from "../ui/ConditionBadge";  // ← replaces inline ConditionBadge
import Breadcrumb from "../ui/Breadcrumb";           // ← replaces inline breadcrumb JSX
import EmptyState from "../ui/EmptyState";           // ← replaces inline "not found" block
import { useAuthStore } from "../store/useAuthStore";

// ── Status + countdown ────────────────────────────────────────────────────────
// Kept inline here intentionally — this version has richer layout than the
// card badge (shows countdown number prominently). Not the same as StatusBadge.
  ...
  return (
    <div className="border border-slate-200 p-4 space-y-3">
      ...
      <div className="flex gap-2">
        ...
        />
        <Button variant="secondary" size="sm" onClick={handleBid}>
...
export default function AuctionDetailPage() {
  ...
  if (!auction) {
    return (
      <main className="min-h-screen bg-neutral1 flex items-center justify-center">
        {/* EmptyState replaces the old inline not-found block */}
        <EmptyState
  ...
  return (
    <main className="min-h-screen bg-neutral1">
      ...
      {/* Breadcrumb replaces the old inline breadcrumb JSX */}
      <Breadcrumb
        items={[
        ...
        <div className="flex flex-col gap-5">
          ...
          <div>
            <div className="flex items-start justify-between gap-3">
              ...
              {/* ConditionBadge replaces the old inline ConditionBadge function */}
